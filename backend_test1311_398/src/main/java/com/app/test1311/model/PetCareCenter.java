package com.app.test1311.model;
...
import com.app.test1311.converter.DurationConverter;
import com.app.test1311.converter.UUIDToByteConverter;
import com.app.test1311.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"test1311_484\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"test1311_484\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"test1311_484\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"test1311_484\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"test1311_484\"")
